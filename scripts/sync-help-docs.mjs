...
const REQUIRED_ASSETS = [
  ...
  "screenshots/module-guide/06-pending-mr-empty-dark.png",
  "screenshots/module-guide/07-pending-mr-list-dark.png",
  "screenshots/module-guide/08-pending-mr-list-light.png",
  "screenshots/module-guide/09-pending-mr-target-dropdown-dark.png",
  "screenshots/module-guide/10-pending-mr-create-dialog-dark.png",
  ...
  "screenshots/module-guide/15-plan-issue-actions-dark.png",
  "screenshots/module-guide/16-plan-discussion-dialog-dark.png",
  "screenshots/module-guide/17-plan-view-light.png",
  "screenshots/module-guide/18-plan-issue-actions-light.png",
  "screenshots/module-guide/19-yunxiao-issue-actions-dark.png",
  "screenshots/module-guide/21-plan-issue-actions-hover-dark.png",
  "screenshots/module-guide/22-yunxiao-issue-actions-light.png",
