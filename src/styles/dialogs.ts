...
export const dialogs = {
  ...
  // 多选下拉(设置页「可选子仓库」等):Radix Select 不支持多选,改用 Popover + 复选框。
  // 触发器复用 settingsSelect 的观感,保证与相邻单选框一致。
  settingsMultiSelectTrigger: {
    ...settingsSelectTriggerBase,
    alignItems: "center",
  },
  settingsMultiSelectValue: {
    flex: 1,
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap" as const,
  },
  settingsMultiSelectPlaceholder: {
    flex: 1,
    color: "var(--text-hint)",
    overflow: "hidden",
    textOverflow: "ellipsis",
  ...
  settingsMultiSelectList: {
    ...
    flexDirection: "column",
    gap: 1,
    // 与下方 collisionPadding 配合：空间紧张时列表自身滚动，弹层不顶到视口外
  ...
  settingsMultiSelectOptionChecked: {
    display: "flex",
    alignItems: "center",
    gap: 8,
    padding: "7px 8px",
  ...
  settingsMultiSelectCheckbox: {
    flexShrink: 0,
    accentColor: "var(--accent)",
    cursor: "pointer",
  },
  settingsMultiSelectLabel: {
    flex: 1,
    overflow: "hidden",
    textOverflow: "ellipsis",
    whiteSpace: "nowrap" as const,
  },
  settingsMultiSelectHint: {
    padding: "8px",
    fontSize: 12,
    color: "var(--text-hint)",
    lineHeight: 1.5,
  },
  settingsMultiSelectSeparator: {
    height: 1,
    background: "var(--border-dim)",
    margin: "4px 6px",
  },
